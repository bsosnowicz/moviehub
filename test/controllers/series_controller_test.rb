...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference("Series.count") do
      post series_index_url, params: { series: { description: @series.description, no_of_seasons: @series.no_of_seasons, rating: @series.rating, release_date: @series.release_date, title: @series.title } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { description: @series.description, no_of_seasons: @series.no_of_seasons, rating: @series.rating, release_date: @series.release_date, title: @series.title } }
